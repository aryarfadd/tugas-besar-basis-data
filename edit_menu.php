        ...
        <div class="form-group">
          ...
          <div class="form-check">
            <label class="form-check-label">
              <input type="radio" class="form-check-input" name="jenis_produk" value="Matic">Matic 
            </label>
          </div>
          <div class="form-check">
            <label class="form-check-label">
              <input type="radio" class="form-check-input" value="Non_Matic" name="jenis_produk">Non Matic
            </label>
          </div>
         </div>
        <div class="form-group">
